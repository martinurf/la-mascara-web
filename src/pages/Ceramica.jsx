        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-2xl">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Cada figura nace de sus manos. Pintadas a mano con pasión, pieza por pieza en el taller de Rocío.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            {filtradas.map((item, i) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <a
                    href={`https://wa.me/${WHATSAPP}?text=${encodeURIComponent(`¡Hola Rocío! Me interesa la figura "${item.nombre}". ¿Cuál es el precio?`)}`}
                    target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          {personalizados.length > 0 ? (
            ...
            >
              ...
              <p className="text-gray-500 text-sm">Fotos de trabajos personalizados próximamente.</p>
              <p className="text-gray-400 text-xs mt-1">¡Contáctanos para cotizar tu idea ya!</p>
            </motion.div>
          )}
